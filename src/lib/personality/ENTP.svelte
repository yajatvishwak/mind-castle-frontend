<div class="flex items-center justify-center ">
    <div class="font-semibold text-center rounded-3xl p-10 max-w-xs">
        <img
            ...
            src="https://static.neris-assets.com/images/personality-types/avatars/entp-debater.png"
            alt=""
        />
        <h1 class="text-lg opacity-50">ENTP</h1>
        <h1 class="text-lg opacity-50">THE VISIONARY</h1>
        ...
        <h1 class="mt-4 text-lg opacity-50">The ENTP Personality Type</h1>
        <div class="mt-4">
            ENTPs are inspired innovators who are driven to come up with fresh
            ...
            <br />
            ENTPs like experimenting with concepts and especially appreciate engaging
        ...
        <h1 class="mt-4 text-lg opacity-50">What does ENTP stand for?</h1>
        <div class="mt-4">
            One of the sixteen personality types identified by Isabel Myers and
        ...
        <h1 class="mt-4 text-lg opacity-50">ENTP Values and Motivations</h1>
        <div class="mt-4">
            ENTPs thrive on a challenge and are frequently motivated by issues
            ...
            <br />
            ENTPs excel at reinventing the wheel and frequently object to performing
        ...
        <h1 class="mt-4 text-lg opacity-50">How Others See the ENTP</h1>
        <div class="mt-4">
            The majority of ENTPs are amiable and frequently charming. They
            ...
            <br />
            The ENTP exhibits typical entrepreneurial traits and could be fast to
        ...
        <div class="mt-4">
            One of the less common varieties in the population is ENTP. ENTPs
            consist of:
            <ul>
        ...
        <h1 class="mt-4 text-lg opacity-50">Famous ENTPs</h1>
        <div class="mt-4">
            Famous ENTPs include "Weird Al" Yankovic, Conan O'Brien, Steve Jobs,
        ...
        <h1 class="mt-4 text-lg opacity-50">Facts about ENTPs</h1>
        <div class="mt-4">
            Interesting facts about the ENTP:
            <uL>
                <li>
                    On personality trait scales, scored as Enterprising,
                    Friendly, Resourceful, Headstrong, Self-Centered, and
                    Independent
                </li>
                <li>
                    Least likely of all types to suffer heart disease and
                    hypertension
                </li>
                <li>
                    Least likely of all types to report stress associated with
                    family and health
                </li>
                <li>
                ...
                <li>Overrepresented among those with Type A behavior</li>
                <li>Among highest of all types on measures of creativity</li>
                <li>
                    One of two types most frequent among violators of college
                    alcohol policy
                </li>
                <li>
                    Among types most dissatisfied with their work, despite being
        ...
        <h1 class="mt-4 text-lg opacity-50">ENTP Hobbies and Interests</h1>
        <div class="mt-4">
            The ENTP enjoys furthering their education, writing, appreciating
            art, participating in sports, using computers and playing video
            games, travelling, and attending cultural events.
        </div>
    </div>
</div>
