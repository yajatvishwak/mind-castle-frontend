<div class="flex items-center justify-center ">
    <div class="font-semibold text-center rounded-3xl p-10 max-w-xs">
        ...
        <h1 class="text-lg opacity-50">THE TEACHER</h1>
        ...
        <h1 class="mt-4 text-lg opacity-50">The ENFJ Personality Type</h1>
        <div class="mt-4">
            Idealistic planners, ENFJs are determined to carry out their vision
            ...
            <br />
            ENFJs frequently have a lot on their plates and tend to be enthusiastic
        ...
        <h1 class="mt-4 text-lg opacity-50">What does ENFJ stand for?</h1>
        <div class="mt-4">
            One of the sixteen personality types developed by Isabel Myers and
        ...
        <h1 class="mt-4 text-lg opacity-50">ENFJ Values and Motivations</h1>
        <div class="mt-4">
            ENFJs are motivated by a strong sense of empathy and altruism. They
            ...
            suffering.
            <br />
            ENFJs value intimate relationships and mutual support and think that
        ...
        <h1 class="mt-4 text-lg opacity-50">How Others See the ENFJ</h1>
        <div class="mt-4">
            Natural educators, ENFJs are frequently seen getting others to
            ...
            <br />
            ENFJs are often good communicators with a gift for connecting with others
        ...
        <div class="mt-4">
            ENFJ is one of the less prevalent personality types, particularly
            among men. ENFJ is the second-rarest type among guys. ENFJs consist
            of:
            <ul>
        ...
        <h1 class="mt-4 text-lg opacity-50">Famous ENFJs</h1>
        <div class="mt-4">
            Oprah Winfrey, Martin Luther King, Jr., Margaret Mead, Maya Angelou,
        ...
        <div class="mt-4">
            ...
            <uL>
                <li>
                    ...
                    Sociable, Demanding, Impatient, Appreciative, and
                    Compromising
                </li>
                <li>
                ...
                <li>
                    Most likely of all types to believe in a higher spiritual
                    power
                </li>
                <li>
                    Ranked by psychologists as among least likely to have
                    trouble in school
                </li>
                <li>
                    Personal values include Friendships, Education & Learning,
                    Creativity, and Community Service
                </li>
                <li>
                    Among types highest in job satisfaction, but also among most
                    likely to report plans to leave their jobs
                </li>
                <li>
                    Commonly found in careers in religion, teaching, and the
                    arts
                </li>
            </uL>
        </div>
